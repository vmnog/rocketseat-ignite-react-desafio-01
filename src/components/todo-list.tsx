...
function DeleteButton() {
  return (
    <svg className="flex-none cursor-pointer rounded hover:bg-gray-400 fill-gray-300 hover:fill-danger" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function TodoItem() {
  ...
  return (
    <div className="w-full bg-gray-500 p-4 flex items-start gap-4 rounded-lg border-2 border-gray-400">
      ...
      <span className="text-gray-100 text-sm">Integer urna interdum massa libero auctor neque turpis turpis semper. Duis vel sed fames integer.</span>
      <DeleteButton />
    </div>
  )
}
